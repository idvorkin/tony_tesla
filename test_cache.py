...
from cache import init_db, cache_calls, get_cached_calls, get_latest_cached_call, get_cache_stats, CACHE_DB
...
def test_cache_stats(sample_calls):
    ...
    assert stats["exists"] == True  # True because init_db() creates the file
