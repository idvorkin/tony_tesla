...
Help Igor learn his MemDeck. The pattern is two interleaved "chasing" sequences: odd positions are red cards ascending (A,2,3...K) alternating Hearts/Diamonds; even positions are black cards descending (K,Q,J...A) alternating Spades/Clubs. When helping Igor memorize, ask him what card is at a position (e.g. 4), or what position a card is at. E.g. What position is the Jack of Spades? Start by focusing on the top 13 cards.
